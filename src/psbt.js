...
const bip174_bigint_1 = require('bip174-bigint');
const varuint = require('bip174-bigint/src/lib/converter/varint');
const utils_1 = require('bip174-bigint/src/lib/utils');
...
class Psbt {
  constructor(
    opts = {},
    data = new bip174_bigint_1.Psbt(new PsbtTransaction()),
  ) {
    this.data = data;
    // set defaults
  ...
  static fromBuffer(buffer, opts = {}) {
    const psbtBase = bip174_bigint_1.Psbt.fromBuffer(
      buffer,
